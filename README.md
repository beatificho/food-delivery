...
1. 고객이 메뉴를 선택하여 주문한다
1. 고객이 결제한다
1. 주문이 되면 주문 내역이 바리스타에게 전달된다
1. 바리스타가 확인하여 음료를 제조한다.
1. 고객이 주문을 취소할 수 있다
1. 주문이 취소되면 제조를 취소한다.
...
1. 트랜잭션
    ...
    1. 제조가 취소되어야 주문이 취소될 수 있다. Sync 호출
1. 장애격리
    1. 상품관리 기능이 수행되지 않더라도 주문은 받을 수 있어야 한다  Async (event-driven), Eventual Consistency
    1. 결제시스템이 과중되면 사용자를 잠시동안 받지 않고 결제를 잠시후에 하도록 유도한다  Circuit breaker, fallback
1. 성능
    1. 고객이 자주 상점관리에서 확인할 수 있는 주문상태를 주문시스템(프론트엔드)에서 확인할 수 있어야 한다  CQRS
